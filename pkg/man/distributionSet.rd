...
\alias{distributionClass object}
...
\description{This function is used to create a distributionClass object which contains the parameters of the distribution of the observations
    for each hidden states. Since distributions can be univariate or multivariate, discrete or continuous,
    the different values of a distributionClass object depend of the distribution.}
\synopsis{
distributionSet(dis, ...)
...
\value{ an object of class distributionClass with some of the following elements
    ...
    \item{dimObs}{dimension of observations (for normal distributions and mixture of normal distributions)}
