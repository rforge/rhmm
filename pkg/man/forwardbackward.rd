...
\note{
 ...
 \eqn{\alpha_i(t) = 
 P(O(1)=o(1),\ldots,O(t)=o(t),Q(t)=i|HMM)}{Alpha[i][t] = 
 ...
 \eqn{\beta_i(t) = P(O(t+1)=o(t+1),\ldots,O(T)=o(T),Q(t)=i 
| HMM)}{Beta[i][t] = 
 ...
 \eqn{\rho(t) = P(O(1)=o(1),\ldots,O(t)=o(t)| HMM)}{Rho[t] = P(O[1]=obs[1], \ldots, O[t]=obs(t) | HMM)} which is probabilities of seeing 
 the partial sequence \eqn{o(1),\ldots,o(t)}{obs[1] \ldots obs[t]}.\cr
 
 \bold{Remark: }when the conditional distributions are continuous, all the above probabilities are replaced by densities, 
    so that these quantities \bold{can be greater than one}.\cr
