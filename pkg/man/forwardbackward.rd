...
| HMM)}{Beta[i][t] = 
 ...
 \eqn{\rho(t) = P(O_1=o(1),\ldots,O_t=o(t)| HMM)}{Rho[t] = P(O[1]=obs[1], \ldots, O[t]=obs(t) | HMM)} which is probabilities of seeing 
 the partial sequence \eqn{o(1),\ldots,o(t)}{obs[1] \ldots obs[t]}.\cr
 
 \cr
  Remark: when the conditional distributions are continuous, all the above probabilities are replaced by densities, 
    so that these quantities \bold{can be greater than one}.
